...
public class Main {
    public static void main(String[] args) {
        ...
        Parking parking = new Parking("Underground ExamPreparation.DefiningClases.parking garage", 5);
...
// The cars are parked in Underground ExamPreparation.DefiningClases.parking garage:
// Peugeot 307 (2011)
// Audi S4 (2005)
